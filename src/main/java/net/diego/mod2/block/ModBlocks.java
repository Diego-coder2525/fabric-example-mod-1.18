...
public class ModBlocks {
    ...
    public static final Block MYTHRIL_BUTTON = registerBlock("mythril_button",
            new StoneButtonBlock(FabricBlockSettings.of(Material.METAL).strength(6f).requiresTool().noCollision()),ModItemGroup.MYTHRIL);
    ...
    public static final Block MYTHRIL_LAMP = registerBlock("mythril_lamp",
            new MythrilLampBlock(FabricBlockSettings.of(Material.METAL).strength(4f).requiresTool().luminance((state)->state.get(MythrilLampBlock.CLICKED) ? 15 : 0)),ModItemGroup.MYTHRIL);
